...
public static class Executor
{
    ...
    public static async Task<TResult> Execute<TRequest, TResult>(this IFeature<TRequest, TResult> feature, TRequest request)
    {
    ...
    private static async Task<ExecutionStatus> Before<TRequest, TResult>(IFeature<TRequest, TResult> feature, TRequest request, IEnumerable<IConcern> concerns)
    {
    ...
    private static Task After<TRequest, TResult>(IFeature<TRequest, TResult> feature, TRequest request, TResult result, IEnumerable<IConcern> concerns)
    {
